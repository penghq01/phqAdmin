...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '0b178dfde1b181b81d01ffb628f9c9bd', 1564731355, 'localhost:8181');
...
CREATE TABLE `auth`  (
  ...
  `auth_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '唯一名称',
  ...
  `auth_type` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT '路由类型 0菜单节点，1菜单，2操作（按钮），3超链接',
