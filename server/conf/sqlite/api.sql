...
INSERT INTO "api" VALUES (10, '添加图片', '_admin_api_icon_add', '/admin/api/icon/add', 2, 1, 'adminApi.Icon', 'post:Add', 1);
...
INSERT INTO "api" VALUES (13, '获取权限列表', '_admin_api_auth_list', '/admin/api/auth/list', 2, 1, 'adminApi.Auth', 'post:List', 1);
INSERT INTO "api" VALUES (14, '添加权限', '_admin_api_auth_add', '/admin/api/auth/add', 3, 1, 'adminApi.Auth', 'post:Add', 1);
INSERT INTO "api" VALUES (15, '修改权限', '_admin_api_auth_edit', '/admin/api/auth/edit', 3, 1, 'adminApi.Auth', 'post:Edit', 1);
INSERT INTO "api" VALUES (16, '删除权限', '_admin_api_auth_del', '/admin/api/auth/del', 3, 1, 'adminApi.Auth', 'post:Del', 1);
...
INSERT INTO "api" VALUES (26, '获取角色权限列表', '_admin_api_role_auth_list', '/admin/api/role/auth-list', 2, 1, 'adminApi.Role', 'post:AuthList', 1);
...
INSERT INTO "api" VALUES (30, 'SQL列表', '_admin_api_sql_list', '/admin/api/sql/list', 2, 1, 'adminApi.Admin', 'post:ListSql', 1);
INSERT INTO "api" VALUES (31, '导出sql', '_admin_api_sql_exprot', '/admin/api/sql/exprot', 2, 1, 'adminApi.Admin', 'post:ExportSqL', 1);
INSERT INTO "api" VALUES (32, '导入sql', '_admin_api_sql_improt', '/admin/api/sql/improt', 2, 1, 'adminApi.Admin', 'post:ImportSqL', 1);
INSERT INTO "api" VALUES (33, '删除sql', '_admin_api_sql_del', '/admin/api/sql/del', 2, 1, 'adminApi.Admin', 'post:DelSqL', 1);
INSERT INTO "api" VALUES (34, '删除数据接口', '_admin_api_api_del', '/admin/api/api/del', 3, 1, 'adminApi.Api', 'post:Del', 1);
INSERT INTO "api" VALUES (35, '修改数据接口', '_admin_api_api_edit', '/admin/api/api/edit', 3, 1, 'adminApi.Api', 'post:Edit', 1);
INSERT INTO "api" VALUES (36, '添加数据接口', '_admin_api_api_add', '/admin/api/api/add', 3, 1, 'adminApi.Api', 'post:Add', 1);
INSERT INTO "api" VALUES (37, '获取数据接口列表（分页）', '_admin_api_api_list_paginate', '/admin/api/api/list/:page_size/:page', 3, 1, 'adminApi.Api', 'post:PageList', 1);
INSERT INTO "api" VALUES (38, '获取数据接口列表', '_admin_api_api_list', '/admin/api/api/list', 2, 1, 'adminApi.Api', 'post:List', 1);
